...
HD_PWD='/home/floran/Vivado/aivotta/aivotta.runs/toplevel_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_processing_system7_0_0.tcl
