...
HD_PWD='/home/floran/Vivado/aivotta/aivotta.runs/toplevel_axi_smc_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_axi_smc_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_axi_smc_1_0.tcl
