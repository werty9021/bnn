...
HD_PWD='/home/floran/Vivado/aivotta/aivotta.runs/toplevel_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_rst_ps7_0_100M_0.tcl
