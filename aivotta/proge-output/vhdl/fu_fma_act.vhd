...
end entity fu_fma_act;

architecture rtl of fu_fma_act is

  constant op_ge32x32to32x1_c : std_logic_vector(2 downto 0) := "000";
  constant op_geu16x32to32x1_c : std_logic_vector(2 downto 0) := "001";
  constant op_mac16x32to32x32_c : std_logic_vector(2 downto 0) := "010";
  constant op_max16x32_c : std_logic_vector(2 downto 0) := "011";
  constant op_xnorpopcountacc32x32_c : std_logic_vector(2 downto 0) := "100";
...
begin
  ...
  operations_actual_cp : process(operation_0_r, xnorpopcountacc32x32_op2, geu16x32to32x1_op2, xnorpopcountacc32x32_op3, load_in1t_in, ge32x32to32x1_op1, mac16x32to32x32_op1, mac16x32to32x32_op2, mac16x32to32x32_op3, max16x32_op1, ge32x32to32x1_op2, xnorpopcountacc32x32_op1, geu16x32to32x1_op1, max16x32_op2)
