...
architecture rtl of fu_vops is
  ...
  constant op_vbcast32x32_c : std_logic_vector(3 downto 0) := "1000";
    ...
    if clk = '1' and clk'event then
      if rstx = '0' then
        ...
        if (glock_in = '0') then
          ...
          elsif ((operation_in = op_vbcast32x32_c) and (load_in1t_in = '1')) then
            data_out1_1_r <= vbcast32x32_op2;
