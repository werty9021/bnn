...
int main(){
    ...
    struct FloatTensor2 *l0_input = floattensor_from_file(1, 1, Hin, Win, "../data/input.bin");
    struct FloatTensor2 *float_weights = floattensor_from_file(Co, 1, kernel_size.y, kernel_size.x, "../data/weights/conv0.bin");
    ...
    struct FloatTensor2 *a = floattensor_from_file(1, 1, 1, Co, "../data/thresholds/act15_a.bin");
    struct FloatTensor2 *b = floattensor_from_file(1, 1, 1, Co, "../data/thresholds/act15_b.bin");
    float_output = relu(output, a, b);
    floattensor_to_file(float_output, "../data/output/act15.bin"); // Write output to file
    // fp conv
    float_weights = floattensor_from_file(1, Co, kernel_size.y, kernel_size.x, "../data/weights/conv16.bin");
